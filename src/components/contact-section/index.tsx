    ...
    return (
        ...
        >
            ...
            <p className="text-muted-foreground max-w-xl mx-auto mb-12">
                Fique à vontade para entrar em contato comigo pelos canais abaixo. Estou disponível para novos projetos, parcerias ou apenas bater um papo sobre tecnologia.
            </p>
            ...
            <div className="flex flex-col md:flex-row justify-center items-center gap-6 text-lg">
                ...
                >
                    <Mail className="w-5 h-5" /> murilo1258@hotmail.com
                </a>
                <a
